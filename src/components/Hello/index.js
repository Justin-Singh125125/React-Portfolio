...
const Hello = props => {
    return (
        <div className="hello">
            ...
            <a className="hello__link" href="tel:9169558073"><h6 className="hello__number"><SvgIcon svgClass="hello__icon hello__phone-icon" svgSelection="icon-phone" />(916)-955-8073</h6></a>
